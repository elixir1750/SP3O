...
def train_one_step(
    ...
    def forward_step(data_iterator: DataIterator, model: GPTModel, return_schedule_plan: bool = False) -> tuple[
        ...
        # Runtime-only metadata used to switch from the dense critic warm-up to
        # SP3O's sparse critic supervision. It is not part of rollout storage.
        batch["rollout_id"] = rollout_id
